<template>
  <div>
    <div class="px-[6rem]">
      ...
      ></div>
      <div
        class="h-[calc(100dvh-4.5rem)] flex items-center justify-center relative -z-10"
      >
      ...
      <div class="pb-10">
        ...
        <div class="flex mt-12 gap-[8rem] mr-[5rem]">
          <p class="text-black text-justify text-2xl w-[80%]">
    ...
    <div class="bg-primary px-[6rem] py-[8rem] relative z-10">
      ...
      <div class="grid grid-cols-3 gap-8 mt-[6rem]">
        ...
        >
          ...
          >
            <h3 class="text-3xl">Richad Robert</h3>
            <span class="text-lg text-third">Ketua Tim</span>
          </div>
        </div>
      </div>
      ...
      <div class="">
        ...
        <div
          class="size-[24rem] bg-second absolute top-[9rem] right-0 -z-10"
        ></div>
        <div
          class="size-[38rem] bg-second rounded-full absolute bottom-[3rem] left-[3.4rem] -z-10"
        ></div>
      </div>
    </div>
    <Footer />
