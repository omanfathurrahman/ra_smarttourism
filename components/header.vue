...
<template>
  <header class="flex items-center justify-between h-[4rem] lg:h-[6rem]">
    ...
    >
      <NuxtLink
        to="/"
        class="flex items-center hover:underline underline-offset-4"
      >Beranda</NuxtLink>
      <div
        ...
        <Transition>
          ...
          >
            ...
            <NuxtLink
              to="/anggota-tim"
              class="hover:underline underline-offset-4"
            >Struktur organisasi COE STH</NuxtLink>
            <NuxtLink
              to="/anggota-tim"
              class="hover:underline underline-offset-4"
            >Produk dan Mitra COE STH</NuxtLink>
            <NuxtLink
              to="/anggota-tim"
              class="hover:underline underline-offset-4"
            >Scope Objek COE Smart Tourism dan Hospitality</NuxtLink>
            <NuxtLink
              to="/anggota-tim"
              class="hover:underline underline-offset-4"
            >Scope Smart Tourism dan Hospitality Research Roadmap</NuxtLink>
          </div>
        </Transition>
      </div>
      <div
        class="relative group flex justify-center"
        @mouseover="navHover.aktivitas = true"
      ...
      <div
        class="relative group flex justify-center"
        @mouseover="navHover.program = true"
        ...
        <Transition>
          ...
          >
            <NuxtLink
              to="/mbkm-dan-magang"
              class="hover:underline underline-offset-4"
            >MBKM dan Magang</NuxtLink>
            <NuxtLink
              to="/pengabdian-masyarakat"
              class="hover:underline underline-offset-4"
            ...
            <NuxtLink
              to="/pengabdian-masyarakat"
              class="hover:underline underline-offset-4"
            >Roadmap Penelitian Hotel
            </NuxtLink>
            <NuxtLink
              to="/pengabdian-masyarakat"
              class="hover:underline underline-offset-4"
            >Roadmap Smart Tourism dan Hospitality
            </NuxtLink>
          </div>
        </Transition>
      </div>
    ...
    >
      ...
      <Transition>
        ...
        >
          ...
          >Beranda</NuxtLink>
          <div
            class="relative group flex flex-col lg:flex-row items-start lg:items-center justify-center"
          ...
          >
            ...
            <Transition>
              <div
                class="flex flex-col items-start lg:items-center px-6 py-2 rounded-md top-[95%] *:text-nowrap"
                v-show="navHover.tentangKami"
              >
                <NuxtLink
                  to="/visi-dan-misi"
